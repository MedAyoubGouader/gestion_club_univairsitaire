...
-- Insertion de membres de test (pour valider les cotisations)
INSERT INTO Membre (nom, prenom, email, telephone, poste, statut)
VALUES ('Ali', 'Ben Salah', 'ali.bensalah@club.local', '0610000001', 'Membre', 'Actif');

INSERT INTO Membre (nom, prenom, email, telephone, poste, statut)
VALUES ('Sarra', 'Trabelsi', 'sarra.trabelsi@club.local', '0610000002', 'Secretaire', 'Actif');

INSERT INTO Membre (nom, prenom, email, telephone, poste, statut)
VALUES ('Youssef', 'Mansouri', 'youssef.mansouri@club.local', '0610000003', 'Tresorier', 'Actif');
